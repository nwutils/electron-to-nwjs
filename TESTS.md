...
- **0.35.3**: ?
- **0.35.4**: ?
- **0.35.5**: NOT WORKING (issue with a variable name starting with #)
- **0.36.0**: ?
- **0.36.1**: ?
- **0.36.2**: ?
- **0.36.3**: ?
- **0.36.4**: NOT WORKING (issue with a variable name starting with #)
- **0.37.0**: ?
- **0.37.1**: ?
- **0.37.2**: ?
- **0.37.3**: ?
- **0.37.4**: NOT WORKING (issue with a variable name starting with #)
- **0.38.0**: WORKING
- **0.38.1**: WORKING
- **0.38.2**: ?
- **0.38.3**: WORKING
